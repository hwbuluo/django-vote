...
class VotedQuerySet(QuerySet):
    ...
    def __init__(self, model=None, query=None, using=None, user=None, hints=None):
        self.user = user
        super(VotedQuerySet, self).__init__(model=model, query=query, using=using, hints=hints)
